...
patente = Replace(objRequest("patente"),".","")
...
If doWhat >= "1" and patente>"" Then 
	sSQL = "EXEC dbo.usp_vehiculos_upsert '" & patente & "'," & doWhat
	'Response.write(sSQL)
...
<body>
	...
	<form name="FF" method="post" action="RepartoVehiculos.asp">
 ...
 <%
	...
	<SPAN title="Vehiculo">Patente</SPAN>:&nbsp;
	<input type="text" name="patente" id="patente" maxlength="10" class="width-20">
	<input type="button" class="btn1" value="Agregar" onClick="chkForm(this.form, 1)" style="width:80px;">
	
	

	<!--#include file="./includes/getVehiculos.asp" -->
