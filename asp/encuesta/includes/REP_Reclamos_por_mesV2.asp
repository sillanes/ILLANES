...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="contentTable table-width-xl">
	...
	<tr class="itemTD11">
		...
		<td><a href="./dashboardV2byMonth.asp?startDate=<%=dbRS("FechaFact")&"-01"%>&endDate=<%=dbRS("FechaFact")&"-"&getNumberOfDays(dbRS("FechaFact"))%>" title="Ver estadisticas"><img src="../images/estad.png" alt="Ver estadisticas"></a> </td>
	</tr>
