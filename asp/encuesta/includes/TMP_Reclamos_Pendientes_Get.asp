...
totalPendinetes = 0 
sSQL = "EXEC TMP.usp_reclamos_pendientes_get "
' Response.write(sSQL)
...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="contentTable table-width-xl">
	...
	<tr class="itemTD11">
		...
		<td><a href="javascript:document.FF.fromwhat.value='1';chkForm2(document.FF,1,'<%=dbRS("ReclamoNumero")%>')" title="Ver Reclamo"><img src="../images/eye.png" alt="Ver Reclamo" id="<%=dbRS("ReclamoNumero")%>"></a></td>
	</tr>
