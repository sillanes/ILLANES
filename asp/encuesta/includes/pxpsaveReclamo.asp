...
sSQL = "EXEC pxp.wsp_Reclamo_upd "& CLng("0"&FechaFact) & ","  & CLng("0"&nrocliente2) & "," & CLng("0"&facturaid2) & ",'" & pedcerrado  & "','" & pedfalta & "','" & pedmal  & "','" & txtpedfalta  & "','" & txtpedmal & "','" & pedcomentarios  & "','" & email & "','" & telefono & "'"& "," & CLng("0"&ResolucionMotivoID) 
'Response.write(sSQL)
