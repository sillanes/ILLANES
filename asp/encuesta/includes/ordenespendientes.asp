...
sSQL = "EXEC [dbo].[usp_Ordenes_Pendientes_Sel] "
'Response.write(sSQL)
...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="contentTable table-width-lg" style="width: 100%;margin-bottom: 15px;">
	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tbody><tr class="tableHeader">
				<td colspan="4" align="left"><span class="formHeader">Ordenes - Empretienda Pendientes</span></td>
				</tr>
			</tbody>
		</table>
		</td>
	...
	<%If  NOT dbRS.EOF  Then%>
		<%DO UNTIL dbRS.EOF
			...
			sSQL =  "EXEC  [usp_Ordenes_Pendientes_view] " & dbRS("RowID")
			nombrearchivo = "OrdenesPendientes_" & dbRS("Periodo")  & "_" & dbRS("RowID")
	...
	<tr class="itemTD11"> 
		...
		<td>
		&nbsp&nbsp&nbsp 
		<a href="javascript:document.FF.doWhat.value='1';chkForm2(document.FF,1,<%=dbRS("RowID")%>)" title="Ver Ordenes"><img src="../images/eye.png" alt="Ver Ordenes" id="<%=dbRS("RowID")%>"></a>
		&nbsp&nbsp&nbsp 
	...
	%>
		<tr class="itemTD11" >
			<td colspan ="4"> No hay Ordenes pendientes.</td>
		</tr>
