...
sSQL = "EXEC [dbo].[usp_Ordenes_Pendientes_PorClientes_Sel] " & periodoID
    ...
    <td colspan="5" height="20">
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr class="tableHeader">
          <td align="left"><span class="formHeader">Ordenes Pendientes</span></td>
        </tr>
      </table>
    </td>
  </tr>
...
%>
  <tr class="itemTD11">
    ...
    <td>
      <input type="text"
             name="NroRecibo_<%= dbRS("RowID") %>"
             id="NroRecibo_<%= dbRS("RowID") %>"
             size="8"  maxlength="8"
             pattern="\d{4,8}"
             title="4 a 8 dígitos"
             autocomplete="off">
...
%>
  <tr class="itemTD11">
    <td colspan="5">No hay ordenes pendientes.</td>
  </tr>
<% End If %>
</table>
