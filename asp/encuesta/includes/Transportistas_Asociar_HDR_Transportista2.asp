...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="contentTable table-width-sm">
	...
	<tr class="itemTD11">
		...
		<a href="javascript:document.FF.doWhat.value='3';chkForm5(document.FF,3,<%=HojaDeRutaID%>,<%=TransportistaID%>,<%=dbRS("TransportistaID")%>,1)" title="Selecionar Transportista"><img src="../images/vincular.png" alt="Selecionar Transportista" id="<%=dbRS("TransportistaID")%>"></a>
