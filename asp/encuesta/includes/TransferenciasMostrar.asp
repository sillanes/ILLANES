...
sSQL = "EXEC dbo.usp_Transferencias_Sel "& TransferenciaID
'Response.write(sSQL)
...
%>
	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tbody><tr class="tableHeader">
				<td colspan="4" align="left"><span class="formHeader">Transferencias</span></td>
				</tr>
			</tbody>
		</table>
		</td>
	...
	<%
			...
			FechaDeposito = dbRS("FechaDepositoECheck")
			Ok = dbRS("OK")
	...
	%>
		<tr class="itemTD11" >
			<td colspan ="4"> No existe la transferencia</td>
		</tr>
...
<div>
	...
	<tr>
		<td>
		<span>Deposito eCheq</span>
		</td>
		
		<td>
			<input type="text" id="depositoecheq" name="depositoecheq"  minlength="6" required value="<%=FechaDeposito%>"> 
		</td>
	...
	<tr>
		<td>
		<span>NroCliente</span>
		</td>
		
		<td>
			<input type="text" id="NroCliente" name="NroCliente"   required value="<%=NroCliente%>"> 
		</td>
		<td>
		</td>
	</tr> 
