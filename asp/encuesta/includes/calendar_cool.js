...
Calendar.prototype.hideShowCovered = function () {
	...
	//var tags = new Array("select", "applet", "iframe");
	var el = this.element;
...
("Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabados", "Domingo");
Calendar._MN = new Array
("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");

// tooltips
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "Cambiar el primer día de la semana";
Calendar._TT["PREV_YEAR"] = "Año pasado";
Calendar._TT["PREV_MONTH"] = "Mes pasado";
...
Calendar._TT["SUN_FIRST"] = "Mostrar Domingos primero";
Calendar._TT["CLOSE"] = "Cerrar";
Calendar._TT["TODAY"] = "Hoy";

// date formats
Calendar._TT["DEF_DATE_FORMAT"] = "dd-mm-y";
Calendar._TT["TT_DATE_FORMAT"] = "DD d de MM";
Calendar._TT["WK"] = "";
 ...
 *
 *  None of them is required, they all have default values.
 */
Calendar.setup = function (params) {
	...
	function onSelect(cal) {
		...
		if (cal.params.displayArea) {
			//changed by murat at April 15 2004 to not to display date in display area....
