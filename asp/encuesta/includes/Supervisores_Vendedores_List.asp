...
<table  border="0" align="center" cellpadding="0" cellspacing="0" class="contentTable">
	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" >
			<tbody><tr class="tableHeader">
				<td align="left" colspan="11"><span class="formHeader">Clientes</span></td>
				</tr>
			</tbody>
		</table>
		</td>
	...
	<tr class="itemTD11">
		...
		<td><a href="javascript:chkForm2(document.FF2,1,'<%=dbRS("VendedorID")%>','<%=dbRS("Nombre")%>')" title="Ver Clientes"><img src="../images/eye.png" alt="Ver Cliente" id="<%=dbRS("VendedorID")%>"></a></td>
		<td nowrap> 
	...
	%>
		<tr class="itemTD11" >
			<td colspan ="11"> No tiene vendedores asociados</a>.</td>
		</tr> 
