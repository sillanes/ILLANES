...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="contentTable table-width-sm">
	...
	<tr class="itemTD11">
		...
		<a href="javascript:document.FF.doWhat.value='1';chkForm2(document.FF,1,<%=dbRS("EmpleadoID")%>,<%=dbRS("Telefono")%>)" title="Modificar Telefono"><img src="../images/control.png" alt="Modificar Faltante" id="<%=dbRS("EmpleadoID")%>"></a>
