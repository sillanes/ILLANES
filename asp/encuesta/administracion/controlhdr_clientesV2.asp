...
If hdrid = "" Then
    Response.Redirect "controlhdrv2.asp"
End If
...
<div class="main-content"> 
    ...
    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">
        ...
        <a href="controlhdrV2.asp?fecha=<%=fecha%>&transportista=<%=transportista%>" 
           class="icon-btn" 
           title="Volver"
        ...
        <a href="terminarhdr.asp?hdrid=<%= hdrid %>&fecha=<%=fecha%>&transportista=<%=transportista%>" 
           class="icon-btn"   
           style="background-color: #ff030e; color: white; padding: 8px 12px; border-radius: 4px; text-decoration: none; margin-left: 10px;">
    ...
    <table class="table table-striped">
        <tbody>
            ...
            Set rs = conn.Execute("EXEC [dbo].[usp_Transportista_HojaDeRuta_Cabecera_selV2] " & hdrid)
...
<td>
    <div class="action-buttons">
        ...
        %>
                 <a href="controlhdr_validar_cobranza.asp?hdrid=<%= hdrid %>&clienteid=<%= rs("ClienteID") %>&accion=Editar&formapago=<%= Server.URLEncode(nuevaForma) %>" 
        ...
        %>
                <a href="controlhdr_validar_cobranza.asp?hdrid=<%= hdrid %>&clienteid=<%= rs("ClienteID") %>&accion=Invalidar&formapago=<%= Server.URLEncode(nuevaForma) %>"
                   title="Invalidar cobranza" 
                   style="color: red;">
                    <i class="fas fa-times-circle"></i>
                </a>

                <a href="controlhdr_validar_cobranza.asp?hdrid=<%= hdrid %>&clienteid=<%= rs("ClienteID") %>&accion=Validar&formapago=<%= Server.URLEncode(nuevaForma) %>" 
