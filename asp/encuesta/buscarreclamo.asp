...
<body>
	...
	<form name="FF" method="post" action="buscarreclamo.asp">
...
%>	 	
		...
		<div>
			...
			<tr>
				...
				<td>
					<input type="text" id="idcliente" name="idcliente" placeholder="12312" minlength="4" required value="<%=idCliente%>"><span class="labelError" id="clientemsg"></span>
				</td>
			...
			<tr>
				...
				<td>
					<input type="text" id="idfactura" name="idfactura" placeholder="1245" minlength="4" required value="<%=idFactura%>"><span class="labelError" id="facturamsg"></span>
				</td>
				<td>
				</td>
			</tr>
...
<%
	...
	<!--#include file="./includes/BuscarUnReclamo.asp" -->
 ...
 <%
	End If
	If doWhat>="2" Then
			%><!--#include file="./includes/getReclamoCliente.asp" --><%
			%><!--#include file="./includes/Reclamos_Mensajes_History.asp" --><%
			%>
			<input type="button" class="btn1" value="Volver" onClick="resetForm(this.form, 1)" style="width:80px;">
			<%
