...
hojaderuta = objRequest("hojaderuta") 
...
<body>
	...
	<form name="FF" method="post" action="hojaderuta.asp">
	<input type="hidden" name="doWhat" value="<%=doWhat%>"> 
	<input type="hidden" name="hojaderuta" value="<%=hojaderuta%>"> 
 ...
 <%
    ...
    <div class="wrap" style="width: 70%" align="center">
	<!--#include file="./includes/HojaDeRuta_EnProceso.asp" -->
	<!--#include file="./includes/HojaDeRuta_Enviados.asp" -->
...
<%
	...
	<!--#include file="./includes/HojaDeRuta_Mostrar.asp" --> 
...
<%
	...
	<!--#include file="./includes/HojaDeRuta_Enviar.asp" --> 
	<br />
	<span class="textSuccess">La hoja de ruta fue ingresada para envio</span><br/>
...
<%
	...
	<!--#include file="./includes/HojaDeRuta_Eliminar.asp" --> 
	<br />
	<span class="textSuccess">La hoja de ruta <%=hojaderuta%> fue ingresada eliminada</span><br/>
