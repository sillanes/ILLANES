...
If step = "" Then step = "1"
 ...
 Function do_Upload(rel_Folder)
  ...
  HTML = HTML & "  <label for='File1'>Seleccione un archivo excel con telefonos:</label>"
  ...
  HTML = HTML & "  <button type='button' onclick='window.location.href=""campania_whatsapp_configurar.asp?CampaniaID=" & CampaniaID & """' class='btn-cancelar'>Cancelar</button>"
  HTML = HTML & "</div>"
  HTML = HTML & "</form>"
...
If step = "1" Then
    If Request.ServerVariables("REQUEST_METHOD")="POST" And Request.Form("action")="guardarPaso1" Then
        ...
        conn.Execute sqlUpd
        Response.Redirect "campania_whatsapp_configurar.asp?CampaniaID=" & CampaniaID & "&step=2"
    End If
...
<form method="post" action="campania_whatsapp_configurar.asp?CampaniaID=<%=CampaniaID%>&step=1">
...
<h2>Paso 2: Adjuntar excel con telefonos</h2>
<% 
	...
	%> 
		...
		<div class="form-actions" style="text-align:center; margin-top:25px;">
            <button type="button" 
                    onclick="window.location.href='campania_whatsapp_configurar.asp?CampaniaID=<%=CampaniaID%>&step=5'" 
                    class="btn-volver">
                Siguiente
            </button>

			<button type="button" onclick="window.location.href='campania_whatsapp_configurar.asp?CampaniaID=<%=CampaniaID%>&step=1'" class="btn-cancelar">
				Volver
			</button>
...
If step="5" Then
    If Request.ServerVariables("REQUEST_METHOD")="POST" And Request.Form("action")="guardarPaso5" Then
		...
		Response.Redirect "campania_whatsapp_configurar.asp?CampaniaID=" & CampaniaID & "&step=6"
    End If
%>
...
<form method="post">
    ...
    <div class="form-actions" style="text-align:center; margin-top:25px;">
		...
		<button type="button" onclick="window.location.href='campania_whatsapp_configurar.asp?CampaniaID=<%=CampaniaID%>&step=4'" class="btn-cancelar">
			Volver
		</button>		
    </div>
</form>
