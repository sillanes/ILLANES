<div class="sidebar"> 
    <ul class="menu"> 
        ...
        <li class="menu-item">
            ...
            <ul class="submenu">
                <li><a href="empleado_recibos.asp"><i class="fa-solid fa-file-lines"></i> Recibos</a></li> 
                <li><a href="empleado_vacaciones.asp"><i class="fa-solid fa-plane-lock"></i> Vacaciones</a></li>  
            </ul>
        </li>		
    </ul>
</div>
