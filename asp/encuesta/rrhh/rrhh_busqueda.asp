...
<div class="main-content">
    <div class="header-row">
        <h2 class="page-title">Busqueda de recibos</h2>
    </div>
    ...
    <div class="card">
        <form method="get" action="rrhh_busqueda.asp">
    ...
    <div class="card">
        <div class="table-wrap">
            <table class="table">
                ...
                %>
                    <tr>
                        <td colspan="8" class="mobile-full" data-label="Resultado">No hay resultados.</td>
                    </tr>
                <%
                Else
                    Do Until rs.EOF
                    ...
                    <tr>
                        ...
                        <td data-label="Acción" class="acciones-col">
                            <div class="acciones-inline">
                                ...
                                <a class="btn-gray" href="rrhh_busqueda_recibo_historial.asp?reciboid=<%=Server.URLEncode(CStr(reciboID))%>">
