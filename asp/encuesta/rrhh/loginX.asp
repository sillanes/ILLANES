...
If Request.ServerVariables("REQUEST_METHOD") = "GET" Then
    patente = Trim(Request.QueryString("patente"))
    contrasena = Trim(Request.QueryString("password"))
Else
            ...
            <div class="card shadow-lg p-4">
                ...
                <form method="post" action="login.asp">
                    <div class="mb-3">
                        ...
                        <input type="text" name="patente" value="<%=patente%>" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Contraseña</label>
                        <input type="password" name="contrasena" value="<%=contrasena%>" class="form-control" required>
                    </div>
                    <%   
                    If patente<>"" Then
