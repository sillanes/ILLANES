...
Dim gPrimaryFolderPDF
Function PrimaryFolder
	if isempty(gPrimaryFolderPDF) then
		gPrimaryFolderPDF = "C:\Administracion\Reparto\Comprobantes\"
		Dim FS: Set FS = CreateObject("scripting.filesystemobject")
		
		if not FS.FolderExists(gPrimaryFolderPDF) then FS.CreateFolder gPrimaryFolderPDF
	end if
	PrimaryFolder = gPrimaryFolderPDF
End Function
