...
<body>
	...
	<form name="FF" method="post" action="subirordenes.asp">
 ...
 <%
	...
	%>
 		...
 		<%=do_Upload("")%>
		<!--#INCLUDE FILE="_commonOrdenes.asp"--> 
		</div>
	<%
	End if
	...
	%>
		<!--#include file="./includes/TMP_Ordenes_DEL.asp" -->
		<!--#include file="./includes/TMP_Ordenes_XLS.asp" -->
		<!--#include file="./includes/Ordenes_Ins.asp" -->
