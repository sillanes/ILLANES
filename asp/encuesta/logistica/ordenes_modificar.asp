...
<div class="main-content">
    ...
    <div class="header">
        ...
        <a href="ordenes_detalle.asp?FechaInicio=<%=toISO(FechaInicio)%>&FechaFin=<%=toISO(FechaFin)%>" class="btn-volver"><i class="fas fa-arrow-left"></i> Volver</a>
    </div>

    <div class="form-container">
        <form method="post" action="ordenes_modificar_guardar.asp">
            ...
            <div class="form-actions">
                ...
                <a href="ordenes_detalle.asp?FechaInicio=<%=toISO(FechaInicio)%>&FechaFin=<%=toISO(FechaFin)%>" class="btn btn-secondary"><i class="fas fa-times"></i> Cancelar</a>
            </div>
        </form>
    </div>
</div>
