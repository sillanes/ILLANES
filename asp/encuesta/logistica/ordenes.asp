...
' ==========================================
Dim rs, sql
sql = "EXEC report.usp_Ordenes_Ventas_sel '" & toISO(FechaInicio) & "','" & toISO(FechaFin) & "'" & ",'Logistica'"
...
<tr>
    ...
    <td>
        <a href="ordenes_detalle.asp?FechaInicio=<%=toISO(FechaInicio)%>&FechaFin=<%=toISO(FechaFin)%>">Ver</a>
    </td>
</tr>
<%
    rs.MoveNext
