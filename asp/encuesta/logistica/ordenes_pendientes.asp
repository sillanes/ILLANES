...
<%
Do While Not rs.EOF
    Dim pedidos, oro, plata, platino, especial, bronce, importe, faltaCobrar, porcentaje
...
<tr>
    ...
    <td>
        <a href="ordenes_pendietes_detalle.asp?inicio=<%=toISO(FechaInicio)%>&fin=<%=toISO(FechaFin)%>">Ver</a>
    </td>
</tr>
<%
    rs.MoveNext
