...
Dim sqlCamiones, sqlCamionSel, sqlItems, sqlTemp
                        ...
                        <div class="col-12 col-md-6 col-xl-4">
                            <div class="camion-card p-3">
                                ...
                                <div class="card-actions">
                                    <a href="camiones_facturas.asp?CamionID=<%=rsCamiones("CamionID")%>" class="btn btn-dark w-100" title="Trabajar con este camión">
                                        <i class="fa-solid fa-truck-fast me-1"></i> Trabajar con este camión
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <% Do Until rsItems.EOF %>
                            <div class="col-12 col-xl-6">
                                <div class="item-card p-3">
                                    ...
                                    <div class="card-actions">
                                        <a href="camiones_factura_control.asp?CabeceraID=<%=rsItems("CabeceraID")%>&CamionID=<%=camionIDSel%>&BuscarArticulo=<%=Server.URLEncode(buscarArticulo)%>" class="btn btn-primary flex-fill" title="Controlar">
                                            <i class="fa-solid fa-clipboard-check me-1"></i> Controlar factura
                                        </a>
                                    </div>
                                </div>
                            </div>
