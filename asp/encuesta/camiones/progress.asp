...
<Head>
 ...
 <Title><%=PercBytesRead%>% Completado - Subiendo a <%=Request.ServerVariables("HTTP_HOST")%> en proceso </Title>
</Head>

<Body BGcolor=Silver LeftMargin=15 TopMargin=4 RIGHTMARGIN=4 BOTTOMMARGIN=4>

<Table cellpadding=0 cellspacing=0 border=0 width=100% ><tr>
<td>Subiendo:<br> <%=TotalBytes%> to <%=Request.ServerVariables("HTTP_HOST")%> ...<br></td>
...
<br><Center><Input Type=Button Value="Cancelar Subida" OnClick="Cancel()" 
