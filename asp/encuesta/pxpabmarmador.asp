...
armador = objRequest("armador") 
ArmadorID = objRequest("ArmadorID")  
...
<body>
	...
	<form name="FF" method="post" action="pxpabmarmador.asp">
	<input type="hidden" name="doWhat" value="<%=doWhat%>"> 
	<input type="hidden" name="armador" value="<%=ArmadorID%>"> 
	
    <div class="wrap" style="width: 70%" align="center">
	<h1>CONFIGURACION ARMADOR</h1>
 <%
	if doWhat="" or doWhat="0"then 
	%>
 
  
	<!--#include file="./includes/pxpComboArmadores.asp" -->
	<!--#include file="./includes/pxpArmadores_sel.asp" -->
...
<%
	...
	<!--#include file="./includes/pxpAgregarArmador.asp" --> 
	<br />
	<span class="textSuccess">Armador Modificado</span><br/>
...
<%
	...
	<!--#include file="./includes/pxpQuitarArmador.asp" --> 
	<br />
	<span class="textSuccess">Armador modificado</span><br/>
