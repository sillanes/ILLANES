...
<body>
	...
	<form name="FF" method="post" action="pxppendientescontrol.asp">
...
%>	 	 
		<h1>PENDIENTES</h1>
  <!--#include file="./includes/pxpHojaDeRuta_Pendientes.asp" -->
...
<%
	...
	if doWhat>="1" Then
		...
		<!--#include file="./includes/pxpHojaDeRuta_Pendientes_View.asp" -->    
		<div align="center">
			<br/> 
...
function chkVerClientes(Fm,prm,param1){  
	Fm.doWhat.value = prm;
