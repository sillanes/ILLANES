...
<body>
	...
	<form name="FF" method="post" action="reclamoscheck_test_v2.asp">
...
%>	 	
		...
		<!--#include file="./includes/TMP_getReclamosPendientes.asp" -->
...
%>	
	...
	<td>
		<span  class="pagetitle">
			...
			<textarea id="textarea1" name="txtresolucion" style="overflow:auto;resize:none" wrap="hard" rows="12" cols="20" maxlength="500"><%=dbRS("NombreCliente")%></textarea>
		</span>
	</td>
	</tr>
	...
	<div align="center">
		...
		<input type="button" class="btn1" value="Seguiente" onClick="chkForm3(this.form, 2,1,'<%=idReclamo%>')">
...
<%
	...
	If doWhat="2"  Then
%>	
		<!--#include file="./includes/TMP_ResolucionSave_step2.asp" -->
		<!--#include file="./includes/TMP_Resolucion_step2_sel.asp" -->
	...
	<td>
		<span  class="pagetitle">
			<span>Comentario hacia el cliente</span> 
			<div align="left">
				<span  id="txtre" class="textInfo"><%=trim(dbRS("Comentario"))%> </span>
			</div> 
...
%> 
	...
	<td>
		<span  class="pagetitle">
			<span>Comentario hacia el cliente</span> 
			<div align="left">
				<span class="textInfo"><%=trim(dbRS("Comentario"))%> </span>
			</div> 
...
%>	
	<form name="FF2" method="post" action="reclamoscheck_test_v2.asp">
	<%
	if doWhatPre="1" Then 
	%>
	<!--#include file="./includes/TMP_ResolucionSave_step2.asp" -->
	...
	End If
	%>
	<!--#include file="./includes/TMP_ResolucionSave_step3.asp" -->
	<!--#include file="./includes/TMP_Resolucion_Save.asp" -->
	<!--#include file="./includes/Resolucion_Save.asp" -->
	<!--#include file="./includes/getReclamoHeader.asp" -->
