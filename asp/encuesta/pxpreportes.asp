...
<body> 
	...
	<h1>Reporte Total Armados por mes</h1> 
	<!--#include file="./includes/REP_Armados_Por_Mes.asp" -->	
	</div>

    <div class="wrap" style="width: 70%" align="center">
	<h1>Reporte Total Controlados por mes</h1> 
	<!--#include file="./includes/REP_Controlados_Por_Mes.asp" -->	
	</div>
	
    <div class="wrap" style="width: 70%" align="center">
	<h1>Reporte Armadores por mes</h1> 
	<!--#include file="./includes/REP_Armadores_Por_Mes.asp" -->	
	</div>

    <div class="wrap" style="width: 70%" align="center">
	<h1>Reporte Controladores por mes</h1> 
	<!--#include file="./includes/REP_Controladores_Por_Mes.asp" -->	
	<input type="button" class="btn1" value="Volver Menu" onClick="resetForm(this.form)">
	</div>	
