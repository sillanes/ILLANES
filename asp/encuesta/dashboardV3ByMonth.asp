...
'ON ERROR RESUME NEXT
sSQL = "EXEC [report].[usp_Reclamos_Resolucion_Motivos_Rep_V3] " & PeriodoID 
' Response.write(sSQL)
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		...
		dataPoints: [
			...
			{ y: <%=MERCADERIA_DANADA%>, name: "MERCADERIA DANADA" },
...
<body> 
	...
	<form name="FF" method="post" action="dashboardv3.asp">
	<input type="hidden" name="doWhat" value="<%=doWhat%>"> 
  
    <div class="wrap" style="width: 70%" align="center">
	<h1>Reclamos por Armador</h1> 
	<!--#include file="./includes/REP_reclamos_por_ArmadorV3.asp" -->	
	</div>
