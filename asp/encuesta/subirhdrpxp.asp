...
<body>
	...
	<form name="FF" method="post" action="subirhdrpxp.asp">
	...
	<h1>HOJAS DE RUTA PEDIDO POR PEDIDO</h1>
 <%
	if doWhat>="" then 
		if doWhat = 3 then
			%>
	...
	%>
 		...
 		<%=do_Upload("")%>
		<!--#INCLUDE FILE="_commonHojaDeRutaPxP.asp"--> 
		</div>
	<%
	End if
	...
	%>
		<!--#include file="./includes/HojaDeRutaPxP_Del.asp" -->
		
		<!--#include file="./includes/hojaderutaPxPxls.asp" -->
			
		<!--#include file="./includes/HojaDeRutaPxP_Ins.asp" -->
